...
<div class="topnav">
  ...
  <h3 style="margin-left:50px;"><b>Service Request</b></h3>
  <form style="width:75%;">

  <div class="elem-group">
    <label for="catogory-selection">Category</label>
    <select id="category-selection" name="vehicle_category" required>
        <option value="2wheel">Two Wheeler</option>
        <option value="3wheel">Three Wheeler</option>
        <option value="4wheel">Four Wheeler</option>
   ...
   <div class="elem-group">
    ...
    <input type="text" id="model" name="vehicle_number"  required>
  </div>
  <div class="elem-group">
  ...
  <div class="elem-group">
    ...
    <input type="text" id="brand" name="vehicle_brand"  required>
  </div>

  <div class="elem-group">
    <label for="checkin-date">Service Date</label>
    <input type="date" id="checkin-date" name="date" required>
  </div>
  <div class="elem-group">
    <label for="checkout-time">Service Time</label>
