...
<td> <button style="margin-left:700px;width:9%;height:35px;background-color:red;border:none;border-radius:10px;color:white;font-size:15px;">Admin</button></td>
      <td>   <button style="margin-left:70px;width:9%;height:35px;background-color:red;border:none;border-radius:10px;color:white;font-size:15px;margin:-100px-10px; ">Customer</button>
        </td>
</tr>
